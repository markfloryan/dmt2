...
\textbf{\Large CS 3120: Discrete Math and Theory 2} \hfill \textbf{\Large Summer 2026}

\vskip 0.5in 

\makebox[\textwidth][c]{
\begin{tabular}{p{2.6in}p{2.6in}}
    \textbf{MTWRF 10:30 am--12:45 pm} in \textbf{Rice Hall 340} \\
...
Lectures and quizzes will be given in-person and attendance is required.
...
\begin{itemize}
    \item Introduction, Cardinality, Regular Languages
...
There will be three exams (two midterms and one final). The first exam will cover module one, the second will cover modules 2 and 3. THe final exam will be cumulutative with a focus on the final module. The number of exams and topic coverage of those exams is subject to change if necessary but will be announced clearly in class if so. The quiz dates are:

\begin{tabular}{ll}
\textbf{First exam (Module 1):} & Fri. July 24 \\
\textbf{Second exam (Modules 2-3):} & Fri. July 31 \\
\textbf{Final exam (Cumulative):} & Fri. Aug. 7 \\
\end{tabular}

\textbf{Final Exam:} The final exam is scheduled for the last Friday of class (the final class period). Note that this is different from the University schedule, which has the final exam on Saturday Aug. 8.
...
\item \textbf{Attendance:} 20 percent (4 percent deduction for each missed lecture)
\item \textbf{Midterm Exams:} 30 percent (15 percent each)
\item \textbf{Final Exam:} 30 percent
\end{itemize}

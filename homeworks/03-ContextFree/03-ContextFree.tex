...
\begin{itemize}
	\item \textbf{Part 1:} First, show that $A=\{a^mb^nc^n | m,n \geq 0\}$ producing a context-free grammar that generates it.
...
\question[3]{
The grammar below looks like a portion of a reasonable programming language. For this question, you need to first show that this grammar is ambiguous, then re-write the grammar to be unambiguous for the same language.
}
